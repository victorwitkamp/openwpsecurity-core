...
class RequestContext {
	...
	private string $ip_whitelist_filter;

	public function __construct( SettingsStore $settings, IpAddressInspector $ip_address_inspector, ServerRequestInterface $request, string $ip_whitelist_filter ) {
		$this->settings             = $settings;
		$this->ip_address_inspector = $ip_address_inspector;
		$this->request              = $request;
		$this->ip_whitelist_filter  = $ip_whitelist_filter;
	}
	...
	public function is_ip_whitelisted( string $ip_address ): bool {
		...
		return (bool) apply_filters( $this->ip_whitelist_filter, $is_whitelisted, $ip_address );
	}
